...
router.post('/addCourse',
    ...
    (req, res) => {
        if (!validationResult(req).isEmpty()) {
            ...
            addCourse(req.body.className, req.body.quarterID, req.body.classDate, req.body.classSubject, req.body.grade, req.body.tutorID, req.body.classTimes).subscribe(
                (result) => { },
